 ...
 *
 * Verifies getTopologyOverview() on LocalGraph:
 ...
 *
 * Airplane-safe: all reads go through local Kùzu via LocalGraph;
 * no network, no plugin hook involvement.
 */
...
const graph = new LocalGraph(workspace);
