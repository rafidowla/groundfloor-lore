 ...
 * workspace registry, and logs. Workspaces may store sensitive documents
 * such as notes, records, and project data — plaintext-and-readable to
 * the world is malpractice.
 *
 * What this does:
