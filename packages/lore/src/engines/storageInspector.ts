 ...
 *
 * Before Personal plugin turns users loose ingesting gigabytes of photos
 * and video transcripts, we need observability. "The user can't manage
...
function categorize(relPath: string): 'graphBytes' | 'embeddingsBytes' | 'configBytes' | 'logsBytes' | 'modelsBytes' | 'otherBytes' {
    const p = relPath.replace(/\\/g, '/');

    // Kùzu graph files — under .lore/ except lancedb/
