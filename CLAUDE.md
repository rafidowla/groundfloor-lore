...
This project is indexed by GitNexus as **groundfloor-lore** (305 symbols, 816 relationships, 26 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
